...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mrstrangerequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Mrstrangemovie')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mrstrangerequest') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/nkp_pro')
